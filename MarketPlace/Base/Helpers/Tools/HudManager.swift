...
//  MarketPlace
//
//  Created by tanktank on 2022/3/18.
//
...
class LoadingToolView: UIView {
    ...
    // MARK: -文字框属性设置
    /// 单行高度
    static let singleRowHeight: CGFloat = 40
    /// 最小文字宽度
    static let minTextWidth: CGFloat = 140
    /// 最大文字宽度
    ...
    /// 文字框圆角大小 默认5
    static var textCornerRadius: CGFloat = 20.0
    /// 文字框背景颜色 黑色
    static var textViewBgColor: UIColor = UIColor.hexColor("000000")
    /// 文字大小
    ...
    lazy var isAleradlyExit: Bool = {
        ...
        let fatherWindow = UIApplication.shared.windows.filter {$0.isKeyWindow}.first
    ...
    static func show(text: String?) {
        ...
        LoadingToolView.hidden {
            ...
            // 文字
            tool.alertLabel.backgroundColor = LoadingToolView.textViewBgColor.withAlphaComponent(0.5)
    ...
    lazy var alertLabel: UILabel = {
        ...
        label.font = FONT_R(size: LoadingToolView.fontSize)
...
extension String {
    ...
    func getSize(maxSize: CGSize) -> CGSize {
        ...
        var rect = str.boundingRect(with: maxSize, options: .usesLineFragmentOrigin, attributes: [NSAttributedString.Key.font : FONT_R(size: LoadingToolView.fontSize)], context: nil)
